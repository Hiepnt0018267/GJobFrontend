    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-white border-b border-slate-200 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-2xl font-bold text-slate-900 mb-2">Tìm việc làm</h1>
          <p className="text-slate-500 text-sm">Đang phát triển — sẽ ra mắt trong thời gian tới.</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <p className="text-slate-500 mb-6 text-sm max-w-sm mx-auto">
          Trang tìm kiếm việc làm đầy đủ sẽ được triển khai ở Task tiếp theo.
        </p>
        <Link
          to="/"
