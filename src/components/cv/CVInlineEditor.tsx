...
export default function CVInlineEditor({ initial, currentTemplate, templates, profileAvatarUrl, submitLabel, submitting, onSave, onCancel }: Props) {
  ...
  const accentClass = selectedTemplate.layout_key === 'MODERN' ? 'border-blue-600' : selectedTemplate.layout_key === 'CLASSIC' ? 'border-slate-900' : 'border-slate-300'
