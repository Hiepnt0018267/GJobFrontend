...
export default function CategoryCard({ category }: CategoryCardProps) {
  ...
  return (
    <article className="motion-card group flex w-full flex-col items-center gap-3 rounded-xl border border-slate-200 bg-white p-5 text-center hover:border-blue-300 hover:shadow-md">
